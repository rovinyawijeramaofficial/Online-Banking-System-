...
<body>
   ...
   <%
		   ...
		   <div class="form_wrap">
	            ...
	            <div class="input_wrap">
	              <label for="title">Account Type</label>
		            <input type="text" value="<%=resultSet.getString(2)%>" name="Acc_Type">  
		        </div>
		        ...
		        <div class="input_wrap">
	              <label for="title">Min Balance</label>
		              <input type="number" value="<%=resultSet.getString(4)%>" name="minBalance">
		        </div>
		        
		       <div class="input_wrap">
	              <label for="title">loan interest(in percentage %)</label>
		            <input type="number"  value="<%=resultSet.getString(5)%>" name="interest">
		       </div>		   	       
		        
		 <div class="input_wrap">
	              <label for="title">Status</label>
		
		<select name="status" value="<%=resultSet.getString(5)%>">
        ...
        <div class="input_wrap">
		   <input type="submit" name="submit" value="update Account details" class="submit_btn" onclick="myFunction()">
		</div>
