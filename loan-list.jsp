...
<div class="sidebar2">
        ...
        <table border="1">
            ...
            <tr>
            <caption><h1 style="font-family: monospace;">All Loan Details </h1></caption><br>
...
<tr>
    ...
    <td><%=resultSet.getString("loanType") %></td>
    <td><%=resultSet.getString("prefix") %></td>
    <td><%=resultSet.getString("minAmount") %>.00</td>
    <td><%=resultSet.getString("maxAmount") %>.00</td>
    ...
    <td> <a href="updateLoan.jsp?id=<%=resultSet.getString("id") %>" class="up"><button class="addLoan">Edit</button></a></td>
             
                
    <td> <a href="deleteLoan.jsp?id=<%=resultSet.getString("id") %>" class="up"><button class="addLoan">Delete</button></a></td>
